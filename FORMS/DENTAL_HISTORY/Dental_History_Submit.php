...
$sql = "INSERT INTO dental_history (Name_Title, P_birth, P_Address, P_HomePhone, P_Cell, P_workPhone, P_Employment, P_Insurance_Company, P_Ins_Policy, P_ID, P_Sign, P_Sign_Date, Dentist_Sign, Dentist_Date, Q1, Q2_1, Q2_2, Q3, Q4, Q5, Q6, Q7, Q8, Q9)VALUES ('$Name_Title', '$B_Day_Set', '$P_Address', '$P_HomePhone', '$P_Cell', '$P_workPhone', '$P_Employment', '$P_Insurance_Company', '$P_Ins_Policy', '$P_ID', '$P_Sign', '$P_Sign_Date_Set', '$Dentist_Sign', '$Dentist_Date_Set', '$Question_1', '$Question_2_1', '$Question_2_2', '$Question_3', '$Question4', '$Question5', '$Question_6', '$Question_7', '$Question_8', '$Question_9')";

//Test if query worked when removing participant
if ($con->query($sql) === TRUE) {
	$sql2 = "SELECT ID FROM dental_history WHERE Name_Title = '$Name_Title' AND P_birth = '$B_Day_Set' AND P_Address = '$P_Address' AND P_Sign_Date = '$P_Sign_Date_Set'";
